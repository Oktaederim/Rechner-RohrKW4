document.addEventListener('DOMContentLoaded', () => {
    ...
    const setVelocityBtn = document.getElementById('setVelocityBtn'); // NEU
    ...
    const pressureLossValueEl = document.getElementById('pressureLossValue'); // NEU
    ...
    function updateAllOutputs() {
        ...
        const pressureLossPaM = calculatePressureLoss(velocityMs, diameterMm); // NEU
        const radiusM = diameterMm / 2 / 1000;
        const areaM2 = Math.PI * Math.pow(radiusM, 2);
        ...
        pressureLossValueEl.textContent = `R = ${pressureLossPaM.toFixed(0)} Pa/m`; // NEU
